# Implementation Plan: IClick - macOS Finder Context Menu Extension
...
```
IClick/
├── IClickApp.swift              # Main application entry point
