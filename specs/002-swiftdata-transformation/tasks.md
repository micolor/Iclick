...
**Prerequisites**: Existing SwiftData setup in IClick app, including shared ModelContainer
...
## Path Conventions
- **IClick app**: `IClick/` directory
- **FinderSync extension**: `FinderSyncExt/` directory
- **Models**: `IClick/Model/` directory

## Phase 3.1: Setup
- [ ] T001 Extend Models.swift to include PermissiveDir SwiftData model in IClick/Model/Models.swift
...
- [ ] T009 Implement PermissiveDir SwiftData model in IClick/Model/Models.swift
- [ ] T010 Create helper functions to convert between PermissiveDir struct and model in IClick/Model/Models.swift
